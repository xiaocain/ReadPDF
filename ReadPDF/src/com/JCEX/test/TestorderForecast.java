...
public class TestorderForecast {
...
//		 String url = "http://115.238.63.131:8080/HLApi/api/sendmsg";
		 String url = "http://localhost:8080/READPDFF/api/sendmsg";
//		 String url =
...
//		 String url = "http://api.jcex.com/JCWishPost/api/wish/weight"; //wishceshi复重
		...
		String result = http(url, "orders", encodeParam);
...
//			reader = new BufferedReader(new InputStreamReader(is));
	...
	public static void main(String[] args) throws Exception {
		TestorderForecast.searchOrderInfo();
	}
